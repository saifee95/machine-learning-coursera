...
#
user1 = user1[(user1['CallTime'] < '06:00:00.00000') | (user1['CallTime'] > '22:00:00.00000')]
print(user1['TowerLon'])
print(user1['TowerLat'])
#
...
cor = user1[['TowerLon','TowerLat']]
kmeans = KMeans(n_clusters = 2)
kmeans.fit(cor)
centroids = kmeans.cluster_centers_
bx.scatter(centroids[:,0], centroids[:,1], marker='.', c='red', alpha=0.5, linewidths=3, s=169)
print(centroids)
