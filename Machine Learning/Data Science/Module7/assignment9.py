...
X_train,X_test,y_train,y_test = train_test_split(stud,room,test_size = 0.3,random_state = 7)
...
X_train,X_test,y_train,y_test = train_test_split(stud,enr,test_size = 0.3,random_state = 7)
...
X_train,X_test,y_train,y_test = train_test_split(stud,fail,test_size = 0.3,random_state = 7)
...
amen = X[['Room.Board','Enroll']]
stud = X[['Accept']]
#print(room)
#print(stud)

X_train,X_test,y_train,y_test = train_test_split(amen,stud,test_size = 0.3,random_state = 7)
